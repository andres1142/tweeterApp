...
public class FollowingPresenter extends  FollowInteractionPresenter implements HolderAdapterObserver {

    public FollowingPresenter(ListsView view, User user, AuthToken token) {
